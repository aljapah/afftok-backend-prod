...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'customizeFeedDesc': 'Choose your favorite offer categories',
    ...
    'ar': {
      ...
      'language': 'اللغة',
      'customizeFeed': 'تخصيص الخلاصة',
      'customizeFeedDesc': 'اختر فئات العروض المفضلة لديك',
      ...
      'save': 'حفظ',
      'comingSoon': 'قادم في ريف توك الإصدار الثاني 🔒',
      ...
      'aboutAffTokTitle': 'حول أف توك',
      'aboutAffTokSubtitle': 'تعرف على المزيد عن مهمتنا وقصتنا.',
      
      // About Screen
      'aboutScreenTitle': 'حول أف توك',
      ...
      'tikTokStyleDiscovery': 'اكتشاف على نمط تيك توك',
      'tikTokStyleDiscoveryDesc': 'تصفح المئات من العروض الحصرية في خلاصة جذابة ومذهلة بصريًا.',
